package com.project.paysnap.config;

import com.project.paysnap.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable).cors(cors -> cors.configurationSource(request -> {
                    ...
                    return corsConfig;
                        ...
                        .requestMatchers("/public/*","/success.html","/cancel.html").permitAll()
